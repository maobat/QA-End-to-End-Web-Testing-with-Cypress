describe('Navigation Exercise Solutions', () => {
    ...
    describe('Exercise-1', () => {
        ...
        it.skip('cy.visit(): Navigates to bank accounts page and creates new account', () => {
        ...
        it.skip('cy.visit(): redirects to dashboard when trying to navigate a signed in user to signin page', () => {
            cy.visit('signin');
    ...
    describe('Exercise-2', () => {
        it.skip('cy.go(): navigates back to friends tab', () => {
        ...
        it.skip('cy.go(): creates a new transaction', () => {
